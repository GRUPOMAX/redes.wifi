...
function Main() {
  ...
  // distância até o mais próximo (Haversine)
  const dist = useMemo(() => {
  ...
  return (
    <div className="relative h-[100dvh] w-full overflow-hidden">
      {/* Mapa ocupa a tela toda por baixo */}
      <MapView
        allWifi={all}
        userCoords={userCoords}
        height="100dvh" // cobre a tela toda
        className="absolute inset-0" // se seu MapView aceitar className
      />

      {/* Título (opcional) por cima do mapa */}
      ...
      {/* Card flutuante com raio máximo */}
