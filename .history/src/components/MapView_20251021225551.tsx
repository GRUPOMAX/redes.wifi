...
import MarkerClusterGroup from 'react-leaflet-markercluster'; // ⬅️ trocado
import ClusterListModal from './ClusterListModal';

import L from 'leaflet';
import 'leaflet/dist/leaflet.css';
// CSS do plugin clássico (mantém seu visual)
    ...
    <div className={className} style={{ width: '100%', position: 'relative' }}>
      ...
      >
        ...
        <MarkerClusterGroup
          ...
          // @ts-expect-error prop existe no plugin
          spiderfyOnEveryClick={false}
          disableClusteringAtZoom={19}
          iconCreateFunction={iconCreateFunction}
          eventHandlers={{
            // ✅ evento do plugin clássico
            clusterclick: (e: any) => {
              // evita que o plugin tente dar zoom
              ...
              // abre SEM frescura; se vazio, ainda abre pra mostrar "0 redes"
