...
interface WifiListProps {
  ...
  onEdit: (item: WifiNetwork) => void; // ⬅️ novo
  pageSize?: number;
}
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={goPrev}
            disabled={page === 1}
            className="p-1.5 rounded bg-white/10 enabled:hover:bg-white/20 disabled:opacity-40"
          >
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between gap-3 p-3">
                {/* Clique no nome também inicia edição */}
                <div
