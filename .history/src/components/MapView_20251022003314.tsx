  ...
  return (
    <div className={className} style={{ width: '100%', position: 'relative' }}>
        ...
        <button
          ...
          className="
            group z-[5000] inline-flex items-center gap-2 rounded-xl
            bg-white/90 px-3 py-2 text-sm font-medium text-gray-800 shadow-lg backdrop-blur
            hover:bg-white
            md:absolute md:bottom-3 md:right-3    /* Desktop → canto inferior */
            fixed top-3 right-3 md:static md:top-auto md:right-auto
          "
        >
