  ...
  return (
    <div className={className} style={{ width: '100%', position: 'relative' }}>
      ...
      <button
        ...
        className="group absolute right-3 top-3 z-[5000] inline-flex items-center gap-2 rounded-xl bg-white/90 px-3 py-2 text-sm font-medium text-gray-800 shadow-lg backdrop-blur hover:bg-white"
      >
