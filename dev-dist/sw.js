...
define(['./workbox-77a2df0e'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url
  }) => url.origin.includes("nocodb.nexusnerds.com.br"), new workbox.StaleWhileRevalidate({
  ...
  workbox.registerRoute(({
    request,
    sameOrigin
  }) => sameOrigin && ["style", "script", "worker", "image", "font"].includes(request.destination), new workbox.StaleWhileRevalidate({
